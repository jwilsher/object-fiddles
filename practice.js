...
//band, food, person, book, movie, holiday. Have the values to those keys be 
...
//alsoMe.gender ==== this is dot notation
//alsoMe[gender] === this is bracket notation
...
//Now, loop through your states object and if the states population 
//is greater than 30K, alert that state.
...
//to make sure that each value is truthy. If it's not truthy, 
...
//in the object to be specific to you (name: 'your name', 
//username: 'your username'), rather than my information.

  //Code Here

user1.name = "Jaclyn";
user1.username = "cowley";
...
//Now call the sayName method that's on the user object which will alert 
//the users email
...
var MakePerson = function (name, birthday, ssn) {  //making the function in expression notation
  return {
    name: name,
    birthday: birthday,
    ssn: ssn,
    //sayHi: function() { console.log('hi');} // this would add a sayHi function to the object
    //greeting: greeting //if greeting were to replace ssn...you just could define another function 
    //        pass in that would have displayed a greeting...
  };
};

var me = MakePerson('Ben', '10-14', '1234567'); // returns the Object called "me" with all that info
